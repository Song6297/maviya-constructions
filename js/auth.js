...
import { auth, db, createUserWithEmailAndPassword, signInWithEmailAndPassword, onAuthStateChanged, signOut, sendPasswordResetEmail, doc, setDoc, getDoc, serverTimestamp } from './firebase-config.js';
...
const Auth = {
    ...
    async login(email, password) {
        try {
            ...
            // Ensure user document exists (for users who signed up before this update)
